...
riotRouter({
    ...
    { route: '/shop/setting', tag: 'shop-setting', params: { back: '#/shop/index', title: '店铺设置' } },
    ...
    { route: '/shop/order-printer', tag: 'order-printer',params: { back: '#/shop/index', title: '小票打印机' } },
    ...
    { route: '/shop/index', tag: 'shop-index',params: {title: '店铺' } },
//经营助手
  ...
  '#iposContent': [
    { route: '/main', tag: 'main', default: true }
  ]
});
