<shop-index>
    <ul>
        <li each="{ list }" onclick="{ noAuthTip }"  if={ show }>
            <a>
                <img src="{ img }">
                <div>{ name }</div>
            </a>
...
//      var isBqCommercial =window.isAndroidBq?window.isBqCommercial:utils.judgeBqCommercial();
        self.list = [
            ...
            {  name: '经营助手', img: 'imgs/business-bq.png', link: '#/shop/business-assistant-bq' , logName: '0304',authCode: '61',show:true},

            {  name: '外接设备', img: 'imgs/device.png', link: '#/shop/order-printer', logName: '0305',authCode: '71',show:true },
...
//          {  name: '支付二维码', img: 'imgs/qrcode.png', link: '#/shop/qrcode', logName: '0307',authCode: '72',show:true },
            {  name: '店铺设置', img: 'imgs/shop-message.png', link: '#/shop/setting', logName: '0308',authCode: '91',show:true}
