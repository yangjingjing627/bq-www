<return-order>
    <div class="calendar-bar">
        ...
        <a class="switch" href="#/shop/sales-order" if="{ type==2 }">结算单</a>
    </div>
            ...
            <div class="order-detail-list"} >
                ...
                <ul>
                    <li each="{ item in orderDetail.list }">
                        ...
                        <span style="width: 14%">{ item.amount || item.quantity*item.price }</span>
                    </li>
                </ul>
            </div>
    ...
    <script>
        ...
        self.print = function(e) {
            ...
            httpGet({
                ...
                params: { billUuid: self.currentOrder.refundBillUuid },
