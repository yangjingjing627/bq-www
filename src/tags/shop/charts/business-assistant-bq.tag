<business-assistant-bq>
    <div class="business-assistant-bq">
        <div class="b-s-top">
            <div class="rank">
                <!-- <span>本周海淀区第2名<span> -->
      ...
      <div class="sale-data">
        ...
        <div class="b-s-con">
            ...
            <div class="reportInfo reportInfo-bq">
              分渠道顾客情况
            </div>
          <div class="l-week-sale l-week-sale-bq">
             <ul>
              <li class="bq-bor">
                <dl style="width:100%;" class="">
                  <dt></dt>
                  <dd>门店</dd>
                </dl>
                <ul>
    ...
    <script type="text/javascript">
        ...
        var params = {
            ...
            channel: 1, //channel	渠道 0.ipos 1.bpos
            startDate: self.startDate,
            endDate: self.endDate,
        }
        self.next_gooda = [];
